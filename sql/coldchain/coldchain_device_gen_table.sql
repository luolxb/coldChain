...
(
    ...
    table_comment   varchar(500)                null comment '表描述',
...
INSERT INTO coldchain_device.gen_table (table_id, table_name, table_comment, class_name, tpl_category, package_name, module_name, business_name, function_name, function_author, options, create_by, create_time, update_by, update_time, remark) VALUES (18, 'nts_wechat_user_dept', '微信用户-企业/部门关联表', 'NtsWechatUserDept', 'crud', 'com.nts.business', 'business', 'dept', '微信用户-企业/部门关联', 'nts', null, 'admin', '2020-09-15 10:06:31', '', null, null);